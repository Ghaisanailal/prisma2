        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              ?>
                <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="?page=proses-hapus&id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin ingin menghapus user <?php echo $data['username']; ?>?');"><i class="ti ti-trash"></i></a>
              <?php
                echo "
                        </div>
                      </td>
